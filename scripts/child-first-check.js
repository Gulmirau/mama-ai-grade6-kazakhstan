...
check("mobile rules included", style.includes("@media (max-width: 760px)") && style.includes("max-width: 100vw") && style.includes(".mobile-menu-btn"));
check("interactive guide exists", index.includes("videoModal") && script.includes("guideSlidesData"));
check("video instruction component is ready", index.includes("<video") && index.includes("guideVideoMp4") && style.includes(".video-instruction video"));
